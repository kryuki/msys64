...
/* ________________________________ CONSTANTS ______________________________*/
...
ATJNIISP_API int    STDCALL ispRandomizeBuffer(void);
...
typedef int (STDCALL *PF_ispRandomizeBuffer)(void);
